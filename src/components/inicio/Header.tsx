      ...
      <div className="flex flex-col items-center lg:items-start z-0">
        ...
        <div className="flex items-center justify-center w-full">
          <a
            ...
            className="px-10 py-2 bg-black outline-4 text-white transition delay-300 ease-in-out font-semibold hover:bg-transparent hover:text-black hover:outline-1 hover:outline-black text-2xl 2xl:text-4xl xl:py-5">
            ¡Inscríbete ahora!
          </a>
        </div>
      </div>
